    ...
    <svg viewBox="0 0 92 92" {...props}>
      ...
      <g data-name="Layer 2">
        <g data-name="Layer 1">
          ...
          />
          <path
            d="M54 40.84a14.79 14.79 0 01-20 14 14.78 14.78 0 1017.28-22.39A14.7 14.7 0 0154 40.84z"
            fill="#cedcf0"
          />
          <path
            d="M45.86 31.36a8.84 8.84 0 014.75.84 2.43 2.43 0 01-4.75-.84zM39.58 34a3.43 3.43 0 11-1 4.76 3.43 3.43 0 011-4.76zM47 35a2.43 2.43 0 11-.67 3.36A2.43 2.43 0 0147 35z"
            fill="#efefef"
          />
        </g>
      </g>
